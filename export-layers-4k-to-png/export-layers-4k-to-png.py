...
def python_fu_export_layers_4k_to_png(image, drawable):
...
register(
    "python_fu_export_layers_4k_to_png",
    "Export Layers 4k to PNG",
    "Export Layers 4k to PNG",
    "Brohd",
    "Brohd",
    "2024",
    "<Image>/Filters/MyScripts/Export Layers 4k to PNG",
    "*",
    [],
    [],
    python_fu_export_layers_4k_to_png
