...
def python_fu_export_layers_2k_to_png(image, drawable):
...
register(
    "python_fu_export_layers_2k_to_png",
    "Export Layers 2k to PNG",
    "Export Layers 2k to PNG",
    "Brohd",
    "Brohd",
    "2024",
    "<Image>/Filters/MyScripts/Export Layers 2k to PNG",
    "*",
    [],
    [],
    python_fu_export_layers_2k_to_png
