...
def python_fu_pack_textures_or_to_png(image, drawable):

    export_file_type = "_packed_OR.png"
...
register(
    "python_fu_pack_textures_or_to_png",
    "Pack Textures OR to PNG",
    "Pack Textures OR to PNG",
    "Brohd",
    "Brohd",
    "2024",
    "<Image>/Filters/MyScripts/Pack Textures OR to PNG",
    "*",
    [],
    [],
    python_fu_pack_textures_or_to_png
