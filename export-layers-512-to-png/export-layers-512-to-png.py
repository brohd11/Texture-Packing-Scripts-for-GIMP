...
def python_fu_export_layers_512_to_png(image, drawable):
    ...
    new_dir = os.path.join(file_path_parent, target_res_str)
...
register(
    "python_fu_export_layers_512_to_png",
    "Export Layers 512 to PNG",
    "Export Layers 512 to PNG",
    "Brohd",
    "Brohd",
    "2024",
    "<Image>/Filters/MyScripts/Export Layers 512 to PNG",
    "*",
    [],
    [],
    python_fu_export_layers_512_to_png
